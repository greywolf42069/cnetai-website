...
export class WasmWallet {
    ...
    unlock(_password) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmwallet_unlock(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * Locks the wallet
     */
    lock() {
        wasm.wasmwallet_lock(this.__wbg_ptr);
    }
    /**
     ...
     */
    is_unlocked() {
        const ret = wasm.wasmwallet_is_unlocked(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    sign_message(message) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmwallet_sign_message(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    to_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmwallet_to_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    static fromJson(json_str) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmwallet_fromJson(ptr0, len0);
        if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('cnetai_wasm_signer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
